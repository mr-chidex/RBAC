...
describe('AuthService', () => {
  ...
  describe('validateRegisterationParams', () => {
    it('should throw error if details are not correct', async () => {
      const param = { name: 'test', password: 'invalid', email: 'invalid' } as IUser;
  ...
  describe('register', () => {
    ...
    it('should create a user by admin', async () => {
      ...
      const response = await authService.register(mockUser, mockAdmin);
  ...
  describe('login', () => {
    ...
    it('should throw error on incorrect details', () => {
      const params = { email: 'incorrect', password: 'test' } as IUser;
